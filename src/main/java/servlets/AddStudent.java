...
public class AddStudent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			Write.write(student, "E:/DSA project/ProjectDS/Student.txt");
		...
		TreeMap<String, Student> map1;
		try {
			map1 = (TreeMap<String, Student>) Read.readAll("E:/DSA project/ProjectDS/Student.txt");
